...
class AdminLecturasScreen extends StatelessWidget {
  ...
  Widget _buildRecordRow(
    ...
    final data = doc.data();
    final cita = (data['cita'] ?? '').toString();
    final fecha = _formatDate(data['fechaLectura']);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          AdminHeader(subtitle: 'Registros de Lectura'),
          Expanded(
            child: Padding(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return AdminUserCard(
                            ...
                            buildContent: (_) => AdminUserRecords(
                              uid: docs[index].id,
                              subcollection: 'lecturas',
                              emptyMessage: 'Sin lecturas registradas.',
